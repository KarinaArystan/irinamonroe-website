// Site is now Russian only - no language functionality needed
...
function initMobileMenu() {
    ...
    if (mobileMenuToggle && !mobileMenuToggle.hasAttribute('data-initialized')) {
...
function initDropdown() {
    ...
    if (dropdownToggle) {
        ...
        document.addEventListener('click', function(e) {
            if (window.innerWidth <= 968 && !hasDropdown.contains(e.target)) {
...
// Console message
console.log('Сайт Ирины Монро - успешно загружен');
console.log('Для поддержки: contact@irinamonroe.com');
...
function toggleSearch(button) {
    ...
    if (isMobile) {
        // On mobile, go directly to search page
    ...
    if (!isActive) {
        ...
        // Change button to submit when search is open
        button.type = 'submit';
    } else {
        if (input.value.trim() === '') {
...
document.addEventListener('click', function(e) {
    ...
    searchForms.forEach(form => {
        ...
        if (!form.contains(e.target) && input.classList.contains('active')) {
            input.classList.remove('active');
            button.type = 'button';
        }
    });
...
// Header and Footer injection for pages with placeholders
document.addEventListener('DOMContentLoaded', function() {
    ...
    <header>
        <nav class="container">
            <a href="/" class="logo-link"><div class="logo">IRINA MONROE</div></a>
            ...
            <ul class="nav-links">
                ...
                <li class="has-dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a href="/resources/questions/">Вопросы и ответы</a>
                        <a href="/therapy-sessions/">Онлайн консультации</a>
                    </div>
                </li>
                ...
                <li><a href="/therapy-sessions/" class="nav-cta">Связаться</a></li>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-column">
                    <h4>Обо мне</h4>
                    <p>Психолог и гипнотерапевт с 19+ летним опытом. Помогаю людям найти внутреннюю опору и жить более осознанно.</p>
                ...
                <div class="footer-column">
                    ...
                    <ul>
                        ...
                        <li><a href="/resources/psychology/">Психология и травма</a></li>
                        <li><a href="/resources/questions/">Вопросы и ответы</a></li>
                        <li><a href="/therapy-sessions/">Онлайн консультации</a></li>
                    </ul>
                </div>
                <div class="footer-column">
                    <h4>Свяжитесь со мной</h4>
                    <p>Готовы начать путь к внутренней гармонии? Я здесь, чтобы поддержать вас.</p>
                    <a href="/therapy-sessions/" class="footer-cta">Записаться на консультацию</a>
                </div>
            </div>
            <div class="footer-bottom">
                <div class="footer-links">
                    ...
                    <a href="/therapy-sessions/">Онлайн сессии</a>
                </div>
    ...
    // Initialize all functionality after DOM updates
    initSmoothScrolling();
    initMobileMenu();
    initDropdown();
...
// Also initialize everything on page load for non-placeholder pages
document.addEventListener('DOMContentLoaded', function() {
    // Check if this is a page with actual header (not placeholder)
    if (!document.querySelector('.header-placeholder')) {
        // Initialize immediately for pages with real headers
        initSmoothScrolling();
        initMobileMenu();
        initDropdown();
    }
...
// Ensure initialization happens even if DOM is already loaded
function ensureInitialization() {
    ...
    if (!document.body.hasAttribute('data-initialized')) {
        ...
        // Check if this is a page with actual header (not placeholder)
        if (!document.querySelector('.header-placeholder')) {
            console.log('Initializing for homepage/non-placeholder page');
            initSmoothScrolling();
            initMobileMenu();
            initDropdown();
        }
...
// Final fallback - try initialization after a short delay
